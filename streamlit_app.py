...
with col1:
    ...
    st.write('<font size="+5">', str((energyUsageYearlyKwH_BTC/365) / max_daily_transactions_BTC),'</font>','</br> KwH Per Transaction', unsafe_allow_html=True)
...
with col2:
    ...
    st.write('<font size="+5">', str((energyUsageYearlyKwH_BCH / 365) / max_daily_transactions_BCH ),'</font>','</br> KwH Per Transaction', unsafe_allow_html=True)
