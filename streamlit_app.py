...
col1.header("Setting")
col1.write('Kilowatt Hours (KwH), Yearly:')
col1.write('Terawatt Hours (TwH), Yearly:')


col2.header("BTC")
col2.write('<font size="+8">', str(round(energyUsageYearlyKwH_BTC)),'</font>', unsafe_allow_html=True)
col2.write('<h3>', str(round(slider_energyUsageYearlyTwH_BTC)),'</h3>', unsafe_allow_html=True)
with col2:
    ''' BTC Info here'''


col2.header("BCH")
col2.write('<h3>', str(round(energyUsageYearlyKwH_BCH)),'</h3>', unsafe_allow_html=True)
col2.write('<h3>', str(round(energyUsageYearlyTwH_BCH)),'</h3>', unsafe_allow_html=True)
with col3:
    '''BCH Info Here'''
